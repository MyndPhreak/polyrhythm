    ...
    <div v-if="!isInitialized" class="p-4 bg-info-500/10 border border-info-500/20 rounded-xl">
      <div class="flex items-center space-x-3 mb-3">
        ...
        <div class="text-info-200 text-sm">
          Audio system needs to be started by user interaction
        </div>
      </div>
      <button
        @click="startAudio"
...
import { useAudioV2 } from '~/composables/useAudioV2';
...
const getProviderStatusClass = () => {
  ...
  switch (status) {
    ...
    case 'initializing': return 'text-warning-400';
